...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Cool URLs — Make Websites Great Again" },
      { name: "description", content: "High-converting websites for Pakistani businesses. Not template websites. Conversion-first pages built to turn attention into customers." },
      { name: "author", content: "Cool URLs" },
      { property: "og:title", content: "Cool URLs — Make Websites Great Again" },
      { property: "og:description", content: "High-converting websites for Pakistani businesses, built around conversion rather than templates." },
